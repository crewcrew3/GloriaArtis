...
import ru.itis.gloriaartis.data.impl.BuildConfig as networkConfig
...
internal class NetworkModule {
    ...
    fun provideArtApi(
        ...
        val builder = Retrofit.Builder()
            .baseUrl(networkConfig.METMUSEUM_BASE_URL)
            .client(okHttpClient)
            .addConverterFactory(gsonFactory)

        return builder.build().create(ArtApi::class.java)
    }
