...
import ru.itis.gloriaartis.ui.component.ShimmerCustom
...
internal fun ArtListScreen(
    ...
    //Убрать??
//    when (pageState) {
//        is ArtListScreenState.Initial -> viewModel.processEvent(ArtListScreenEvent.OnScreenInit)
//        is ArtListScreenState.ArtsResult, ArtListScreenState.Loading -> Unit
//    }
